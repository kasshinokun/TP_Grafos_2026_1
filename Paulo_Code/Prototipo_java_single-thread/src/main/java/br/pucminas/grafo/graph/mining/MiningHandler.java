 ...
 * <li>MINING_BUILD_GRAPH1_COMMENTS → payload: interactions (List) → result:
 * graphId "graph1"</li>
 * <li>MINING_BUILD_GRAPH2_CLOSURES → payload: interactions (List) → result:
 * graphId "graph2"</li>
 * <li>MINING_BUILD_GRAPH3_REVIEWS → payload: interactions (List) → result:
 * graphId "graph3"</li>
 * <li>MINING_BUILD_INTEGRATED_GRAPH → payload: interactions (List) → result:
 * graphId "graph_integrated"</li>
 * </ul>
 */
public class MiningHandler {
    ...
    private void onBuildIntegrated(Event ev) {
        ...
        for (Interaction inter : interactions) {
            if (inter.actor.equals(inter.target))
                continue;
