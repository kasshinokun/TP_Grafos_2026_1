 ...
 *
 * <p>
 * Cada método é registrado como um handler no EventBus, respondendo
 * a um EventType específico — equivalente a um endpoint de API.
 * </p>
 *
 ...
 * <li>GRAPH_IS_CONVERGENT → payload: graphId, u1,v1,u2,v2 → result:
 * Boolean</li>
...
public class GraphHandler {
    ...
    /**
     * Evento GRAPH_ADD_VERTEX: expande o grafo existente criando um novo com +1
     * vértice.
