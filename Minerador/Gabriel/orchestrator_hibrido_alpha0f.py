...
# anteriormente, gui_ctk_1d2.py
from gui_ctk import main as gui_main
# anteriormente, gui_pyqt6_1d2.py
from gui_pyqt6 import main as gui_qt_main
...
if __name__ == "__main__":
    ...
    if "--gui" in sys.argv:
        gui_type = (
            input("Deseja usar CTK GUI ou PyQt6 GUI? (1/2): ").strip().lower() == "1"
        )
        if gui_type:
