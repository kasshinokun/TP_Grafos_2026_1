 ...
 *
 * <p>Instancia todos os componentes, registra os handlers no EventBus
 * e expõe o bus para uso externo (CLI, testes, etc.).</p>
 */
public class Application {
    ...
    public GraphRegistry getRegistry() { return registry; }
}
