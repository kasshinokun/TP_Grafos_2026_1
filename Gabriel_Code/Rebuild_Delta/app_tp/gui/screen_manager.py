"""Tela de gerenciamento modular com ComboBox para frames."""
import customtkinter as ctk
from typing import Optional, Callable
from gui.screen_base import BaseScreen

# Imports atualizados para os respectivos arquivos modulares
from gui.frames.gerenciar_grafos import ManageGraphsFrame
from gui.frames.api_primitiva import PrimitiveAPIFrame
from gui.frames.seek_n_path import SearchPathsFrame
from gui.frames.testes_unitarios import UnitTestFrame
from gui.frames.pure_networkx_gui import PureNetworkXFrame
...
class ManagerScreen(BaseScreen):
    ...
    def _build_content(self):
        ...
        self.frames = {
            ...
            "Testes Unitários": UnitTestFrame(self.container),
